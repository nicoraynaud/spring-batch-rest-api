...
public class PojoHelper {
    ...
    public static final LocalDateTime JOB_EXECUTION_CREATE_TIME_DEFAULT = LocalDateTime.parse("2018-12-03T10:15:30");
    public static final LocalDateTime JOB_EXECUTION_START_TIME_DEFAULT = LocalDateTime.parse("2018-12-03T10:15:30");
    public static final LocalDateTime JOB_EXECUTION_END_TIME_DEFAULT = LocalDateTime.parse("2018-12-03T10:15:30");
    public static final String JOB_EXECUTION_EXIT_CODE_DEFAULT = "COMPLETED";
    public static final LocalDateTime JOB_EXECUTION_LAST_UPDATE_DEFAULT = LocalDateTime.parse("2018-12-03T10:15:30");
    ...
    public static Page<JobExecutionEntity> createPageJobExecutionDefault() {
        ...
        jobExecutionEntity.setCreateTime(JOB_EXECUTION_CREATE_TIME_DEFAULT);
        jobExecutionEntity.setStartTime(JOB_EXECUTION_START_TIME_DEFAULT);
        jobExecutionEntity.setEndTime(JOB_EXECUTION_END_TIME_DEFAULT);
        jobExecutionEntity.setExitCode(JOB_EXECUTION_EXIT_CODE_DEFAULT);
        jobExecutionEntity.setLastUpdated(JOB_EXECUTION_LAST_UPDATE_DEFAULT);
